...
public class PowerfulDecoration extends RecyclerView.ItemDecoration {
    ...
    public PowerfulDecoration setDividerWith(int dividerWith) {
        this.dividerWith = dividerWith;
        return this;

    }

    public PowerfulDecoration setDividerColor(int color) {
        initPaint();
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            if (orientation == GridLayoutManager.VERTICAL && lp != null && lp.getSpanIndex() > 0) {
                // 如果列表是垂直方向,则最左边的一列略过
                outRect.left = dividerWith;
            } else if (orientation == GridLayoutManager.HORIZONTAL && lp != null && lp.getSpanIndex() > 0) {
                // 如果列表是水平方向,则最上边的一列略过
